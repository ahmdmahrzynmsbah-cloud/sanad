...
app.post('/api/chat', async (req, res) => {
  ...
  if (!isLegal && words.length <= 4) {
    ...
    if (
      ...
      return res.json({
        reply: `لا، أنا لست إنساناً بشرياً، بل أنا «سَنَد»؛ شخصيتك الافتراضية الذكية ومستشارك القانوني والرقمي المتطور في دولة فلسطين، تم تطويري لمساعدتك في استفسارات القوانين والضرائب والجمارك وكافة الأسئلة المعرفية بكل دقة وسهولة.`,
        isFastReply: true,
        isLegal: false,
        queryType: 'general',
      });
    ...
    if (
      ...
      return res.json({
        reply: `الحمد لله بألف خير ونعمة، شكراً لسؤالك ولطفك! أرجو أن تكون بأفضل صحة وعافية دائماً. تفضل بأي استفسار وسأجيبك بكل سرور ودقة.`,
        isFastReply: true,
        isLegal: false,
        queryType: 'general',
      });
    ...
    if (
      ...
      return res.json({
        reply: `وعليكم السلام ورحمة الله وبركاته! أهلاً وسهلاً بك. أنا «سَنَد»، مستشارك القانوني والتشريعي الذكي. كيف يمكنني مساعدتك اليوم؟`,
        isFastReply: true,
        isLegal: false,
        queryType: 'general',
      });
    ...
    // 5. Thanks (only standalone)
    if (/^(شكرا|شكراً|تسلم|مشكور|الله يعطيك العافية|يعطيك العافية|يسلمو|بارك الله فيك)$/i.test(cleanedLower)) {
      return res.json({
        reply: `العفو، على الرحب والسعة دائماً! أنا في خدمتك في أي وقت لأي سؤال أو استفسار قانوني أو عام.`,
        isFastReply: true,
        isLegal: false,
        queryType: 'general',
      });

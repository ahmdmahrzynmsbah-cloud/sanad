...
app.post('/api/chat', async (req, res) => {
  ...
  if (!isLegal) {
    ...
    if (
      ...
      return res.json({
        reply: `لا، أنا لست إنساناً. أنا «سَنَد»؛ مساعد ذكاء اصطناعي ذكي وشامل مصمم لمساعدتك والإجابة على جميع أسئلتك واستفساراتك العامة والمتخصصة بكل دقة وسهولة.`,
        isFastReply: true,
      });
    }
    ...
    if (
      ...
      return res.json({
        reply: `أنا «سَنَد»، مساعد ذكاء اصطناعي شامل ومتطور، وخبير في القوانين والضرائب والجمارك الفلسطينية، بالإضافة إلى قدرتي على الإجابة عن كافة الأسئلة العامة والمعرفية ومساعدتك في أي موضوع.`,
        isFastReply: true,
      });
    }
    ...
    if (
      ...
      return res.json({
        reply: `الحمد لله بألف خير ونعمة، شكراً لسؤالك ولطفك! أرجو أن تكون بأفضل صحة وعافية دائماً. تفضل بأي استفسار أو موضوع وسأجيبك بكل سرور.`,
        isFastReply: true,
      });
    }
  ...
  const systemInstruction = `أنت "سَنَد"، المساعد والذكاء الاصطناعي الشامل والمستشار الذكي (والمتخصص في القوانين والضرائب والجمارك في دولة فلسطين).

تعليمات الإجابة وقواعد السلوك الصارمة:
1. **الأسئلة العامة والمعرفة العامة والدردشة (أي شيء خارج القوانين والضرائب):**
   - أجب على أي سؤال أو موضوع عام يسألك عنه المستخدم في أي مجال (مثل: الدين الإسلامي، الشخصيات مثل محمد صلاح، كرة القدم، الرياضة، العلوم، التاريخ، التكنولوجيا، الثقافة، الرياضيات، اللغات، أو التحية والدردشة اليومية).
   - إذا سألك المستخدم "هل أنت إنسان؟" أو "أنت إنسان؟": أجب مباشرة وبوضوح تام (مثال: "لا، أنا لست إنساناً، بل أنا «سَنَد»؛ مساعد ذكاء اصطناعي ذكي مصمم لمساعدتك والإجابة على جميع تساؤلاتك...").
   - **ممنوع بتاتاً ومطلقاً** إدراج أو ذكر أي نصوص أو مواد أو مراسيم قانونية في الإجابات العامة غير القانونية! يجب أن تكون إجابتك ذكية، مباشرة، وشاملة.

2. **الاستفسارات والأسئلة عن القوانين والضرائب والجمارك (فلسطين):**
   عندما يسألك المستخدم عن أي قانون أو ضريبة أو جمرك:
   - **التبسيط أولاً وعدم التعقيد:** اشرح الحكم والمفهوم المطلوب بلغة عربية مبسطة وعملية جداً ومباشرة وسهلة الفهم دون تعقيد أو مصطلحات قانونية مبهمة.
   - **تحديد المادة والتوقيت بدقة وبدون إغراق أو سرد القانون كاملاً:**
     اذكر بدقة:
     * اسم التشريع أو القانون الرسمي.
     * توقيت وسنة الصدور والنفاذ (مثال: لسنة 2022م).
     * رقم المادة والفقرة المحددة فقط المعنية بالاستفسار.
     * مضمون المادة باختصار شديد وبشكل موجز.
...
function generateKnowledgeFallback(query: string, laws: StoredLaw[]): string {
  ...
  if (
    ...
    return `أنا «سَنَد»، مساعد ذكاء اصطناعي شامل ومتطور، وخبير في القوانين والضرائب والجمارك الفلسطينية، بالإضافة إلى قدرتي على الإجابة عن كافة الأسئلة العامة والمعرفية ومساعدتك في أي موضوع.`;
  }
  ...
  if (topChunk && (topChunk.score || 0) >= 2) {
    ...
    result += `وفقاً للأحكام والتعليمات الرسمية في فلسطين، فإن هذا الموضوع منظم ومحدد بوضوح:\n\n`;
